# Frostpunk -- Hintforge guide
<!-- v1 -- 2026-06-02 00:00 UTC -->

This folder is a **Hintforge corpus**: a spoiler-controlled reference for the player's Frostpunk playthrough. It is data for a hint companion, **not** an agent task list.
